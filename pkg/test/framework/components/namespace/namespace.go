...
type Config struct {
	...
	// SkipCleanup，如果使能的话，namespace在清理期间不会被删除，用于istio-system ns
	SkipCleanup bool
}
...
// New在所有的clusters创建一个新的Namespace
