...
// XdsResourceGenerator为一个typeURL DiscoveryRequest或者DeltaDiscoveryRequest创建response，如果没有generator和Proxy相关，
// 默认的（一个networking.core.ConfigGenerator实例）会被使用
...
// server可能基于client metadata关联不同的generator，不同的WatchedResources可能使用相同或者不同的Generator
...
// ParseServiceNodeWithMetadata解析Envoy Node，从ServiceNode函数以及metadata产生的string
